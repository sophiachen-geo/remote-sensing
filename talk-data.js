...
const DEFAULTS = [
  { default: "Remove shadow",   answer: "Shadow is the heat refuge",
    body: "After Lytton, after the Vancouver heat dome, shade is public health infrastructure. The shaded suq, the ramada, the tarpaulin in the camp, the cool corner on the north side at 2 PM. A community resilience reading of imagery maps shadows. It does not remove them." },
  { default: "Mask cloud",      answer: "Cloud is the rain",
    body: "For monsoon agriculture, for snowpack on a watershed, for the moisture flux into a parched basin, the cloud is the resource, not the obstruction." },
  { default: "Smooth speckle",  answer: "Speckle is the surface",
    body: "SAR speckle carries information about roughness, soil, ice texture. We filter it because filtering makes the image easier to look at. The price of that is information." },
  { default: "Classify bare",   answer: "Bare is the meeting place",
    body: "The residual class absorbs evacuation gathering points, refugee camp footprints before they become legible, sports fields, schoolyards, festival sites, sacred ceremonial spaces, weekly markets, the open lot where after the earthquake everyone agrees to meet." },
  { default: "Suppress edges",  answer: "Edges are membranes",
    body: "The satellite reads a fence as a binary line. Lived experience reads it as a membrane, with timing, with gaps, with surveillance shadows, with corruption gradients, with the rhythm of patrols. Forensic Architecture built a discipline on the gap between line and membrane." },
];
...
const PAINTING_FIGURES = {
  ...
  aristotle: {
    ...
    thinker: "Hans Jonas, the duty to those here and those who come after",
